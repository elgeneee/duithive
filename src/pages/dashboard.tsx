...
const Dashboard: NextPage = () => {
  ...
  useEffect(() => {
    let dashboardOrdering = localStorage.getItem("dashboardOrdering");

    if (dashboardOrdering) {
      // eslint-disable-next-line @typescript-eslint/no-unsafe-assignment
      dashboardOrdering = JSON.parse(dashboardOrdering);
      setOrder(dashboardOrdering);
    }
  }, []);
                  ...
                  <div className="flex h-36 w-full flex-col justify-between overflow-hidden rounded-lg border border-athens-gray-100 bg-white p-3 lg:w-2/5">
                    ...
                    <div className="flex w-full">
                      <div className="w-full">
                        <p className="flex items-center font-semibold text-[#A0A5AF]">
                          Income
                          <div className="ml-2 h-2 w-2 rounded-full border border-[#62c778] bg-gradient-to-br from-[#55AC68] to-[#92efae]" />
                        </p>
                      ...
                      <div className="w-full">
                        <p className="flex items-center font-semibold text-[#A0A5AF]">
                          Expense{" "}
                          <div className="ml-2 h-2 w-2 rounded-full border border-[#e66b66] bg-gradient-to-br from-[#DA615C] to-[#EFBAB8]" />
                        </p>
                        <p className="text-lg font-semibold">
                          -{userCurrency?.symbol}{" "}
                  ...
                  <div className="flex h-96 w-full flex-col overflow-hidden rounded-lg border border-athens-gray-100 bg-white p-3 lg:w-1/3">
                    ...
                    <div className="relative flex h-full w-full">
                      ...
                      <div className="absolute left-1/2 top-1/2 z-10 -translate-x-1/2 -translate-y-1/2 text-center">
                        ...
                        <Select
                          onValueChange={(value) => pieChartProcess(value)}
                        >
