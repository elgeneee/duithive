...
const BatchIncome: NextPage = () => {
  ...
  const { data: recordsData } = api.income.getBatchIncome.useQuery();

  const { mutate: createBatchIncome, isLoading: isBatchCreateLoading } =
    api.income.createBatchIncome.useMutation({
      onSuccess: () => {
        setExcelFile(null);
        setSuccessRecords([]);
        setFailedRecords([]);
        ...
        void ctx.income.getBatchIncome.invalidate();
      },
      onError: (e) => {
  ...
  return (
    <AppLayout>
      <MotionConfig transition={{ duration: 0.2 }}>
        <main className="p-4">
          <BackButton href="/income" className="mb-10">
            Income
          </BackButton>
          <h1 className="text-3xl font-bold">Batch Upload Income</h1>
          ...
          <div className="mt-10 space-y-5">
            <div className="rounded-md bg-white p-4">
              ...
              <p className="text-[#A0A5AF]">
                Please download the income template first
              </p>
              <a
                href="/DuitHive_Income_Template.xlsx"
            ...
            <div className="h-auto transform rounded-md bg-white p-4">
              ...
              <p className="text-[#A0A5AF]">
                Upload a pre-filled income template file.
              </p>
